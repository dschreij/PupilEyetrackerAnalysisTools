...
def analyze_files_in_folder(folder, surface_name, sacc_threshold=0.9, read_fixations_from_file=False, _sort_result=True):
	...
	for item in folder_contents:
		...
		elif read_fixations_from_file and os.path.isfile(item_path) and "fixations_on_surface_{0}".format(surface_name) in os.path.split(item_path)[1]:
